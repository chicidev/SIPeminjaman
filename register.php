...
/*	include 'koneksi.php';
	...
	die(json_encode($response));
		...
		$num_rows = mysqli_num_rows(mysqli_query($con, "SELECT * FROM users WHERE nim='".$nim."'"));

		if ($num_rows == 0){
			$query = mysqli_query($con, "INSERT INTO users (nim, username, password, noHP, alamat, jk) VALUES('".$nim."','".$username."','".$password."','".$noHP."','".$alamat."','".$jk."')");
